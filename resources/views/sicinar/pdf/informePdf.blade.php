    ...
    <section id="content">
        <table class="table table-hover table-striped" align="center" width="100%"> 
            ...
            <tr>
                ...
                <td style="border:0; text-align:left;font-size:10px;">
                    Fecha de entrega:<b>{{$encpa->fecha_entrega2}}</b><br>
                    ---
                    <!--
                    Mes reportado: <b>
                    &nbsp;&nbsp;
                    @foreach($regmeses as $mes)
                        @if($mes->mes_id == $encpa->mes_id2)
                            {{Trim($mes->mes_desc)}}
                            @break
                        @endif
                    @endforeach
        ...
        <tbody>
            @foreach($regprogdanual as $detpa)
                <tr>
                    ...
                    <td style="text-align:left;vertical-align: middle;font-size:9px;"><p align="justify">{{Trim($detpa->obs_02)}}</p>
                    </td>                                                                                                     
                </tr>
                <tr>
                    <td style="color:green; text-align:center;vertical-align: middle;font-size:9px;" > </td>
                    <td style="color:orange;text-align:left;  vertical-align: middle;font-size:9px;" >Avance  </td>      
                    <td style="color:green; text-align:justify;vertical-align: middle;font-size:9px;">   </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->meta_realizada,0)}}</b>
                    </td>                                                                              
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_01,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_02,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_03,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_04,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_05,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_06,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_07,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_08,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_09,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_10,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_11,0)}}</b>
                    </td>
                    <td style="color:orange;text-align:center;vertical-align: middle;font-size:9px;">{{number_format($detpa->mesc_12,0)}}</b>
                    </td>                   
                </tr>
                <tr>
                 ...
                 <tr>
                    <td style="color:purple;text-align:left; vertical-align: middle;font-size:9px;">        </td>
                    <td style="color:green; text-align:left; vertical-align: middle;font-size:9px;">Semáforo</td>
                    <td style="color:purple;text-align:left; vertical-align: middle;font-size:9px;">        </td>   
                    ...
                    @switch($detpa->semafa_01)
                        @case('1')
                            ...
                            @break
                        @case('2')
                            <img src="{{ asset('images/semaforo_naranja.jpg') }}" width="20px" height="15px" style="text-align:center;margin-right: 15px;vertical-align: middle;"/> 
                            @break
                        @case('3')
                        ...
                        @case('4')
                            ...
                            @break                                            
                        @case('5')
                            <img src="{{ asset('images/semaforo_morado.jpg') }}"  width="20px" height="15px" style="text-align:center;margin-right: 15px;vertical-align: middle;"/> 
                            @break                                                                          
                        @default
                            <img src="{{ asset('images/semaforo_rojo.jpg') }}"    width="15px" height="15px" style="text-align:center;margin-right: 15px;vertical-align: middle;"/> 
                    @endswitch
        ...
        <table class="table table-hover table-striped" align="center" width="100%">
            <tr>
                <td style="border:0; text-align:right;">
                    <b>SECRETARÍA DE DESARROLLO SOCIAL</b><br>UIPPE
                </td>
            </tr>
        </table>
    </footer>    
