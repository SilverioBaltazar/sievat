...
class proganualController extends Controller
{
    ...
    public function actionBuscarPA(Request $request)
    {
        ...
        return view('sicinar.programa_anual.verProganual', compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','totactivs'));
    }
    ...
    public function actionVerPA(){
        ...
        return view('sicinar.programa_anual.verProganual',compact('nombre','usuario','regdepen','regperiodos','regprogeanual','totactivs','regepprog','regepproy')); 
    }
    ...
    public function actionNuevoPA(){
        ...
        $regprogeanual= regProgeAnualModel::select('FOLIO','PERIODO_ID','DEPEN_ID1','DEPEN_ID2','DEPEN_ID3',
                        ...
                        ->orderBy('DEPEN_ID1','asc')
                        ->get();
        return view('sicinar.programa_anual.nuevoProganual',compact('regdepen','nombre','usuario','reganios','regperiodos','regmeses','regdias','regprogeanual','regepproy','regepprog'));
    }
    ...
    public function actionEditarPA($id){
        ...
        return view('sicinar.programa_anual.editarProganual',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','regepproy','regepprog'));
    }
    ...
    public function actionExportPAPDF($id,$id2){
        ...
        if($regprogdanual->count() <= 0){
            ...
            $pdf = PDF::loadView('sicinar.pdf.ProgAnualPdf',compact('nombre','usuario','regumedida','regdepen','regprogeanual','regprogdanual','regepproy','regepprog','regmeses'));
            //$options = new Options();
