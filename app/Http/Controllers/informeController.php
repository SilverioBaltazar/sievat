...
class informeController extends Controller
{
    ...
    public function actionBuscarInforme(Request $request)
    {
        ...
        return view('sicinar.informelabores.verInformes',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','totactivs'));
    }
    ...
    public function actionVerInformes(){
        ...
        return view('sicinar.informelabores.verInformes',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','totactivs','regepprog','regepproy')); 
    }    
    ...
    public function actionExportInformePdf($id,$id2){
        ...
        if($regprogdanual->count() <= 0){
            ...
            $pdf = PDF::loadView('sicinar.pdf.InformePdf',compact('nombre','usuario','regumedida','regdepen','regprogeanual','regprogdanual','regepproy','regepprog','regmeses'));
            //$options = new Options();
    ...
    public function actionVerInformelab($id){
        ...
        return view('sicinar.informelabores.verInformelab',compact('nombre','usuario','regdepen','regumedida','reganios','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regepprog','regepproy'));
    }
    ...
    public function actionEditarInformelab1($id,$id2){
        ...
        return view('sicinar.informelabores.editarInformelab1',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
